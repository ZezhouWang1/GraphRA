...
DATASET_NAME = 'PubMed'  # 'ogbn-products', 'cora', 'pubmed'
K = 5  # you can adjust this parameter by yourself
NUM_LABELS = 3
MAX_LENGTH = 100
BATCH_SIZE = 2
EPOCHS = 60
...
def main():
    ...
    # 使用函数生成数据
    embs_path = 'Data/PubMed/simteg_roberta_x.pt'
    train_top_k_neighbors_path = 'Data/PubMed/train_top_{K}_neighbors.json'
    # valid_top_k_neighbors_path = 'Data/valid_top_k_neighbors.json'
    test_top_k_neighbors_path='Data/PubMed/test_top_{K}_neighbors.json'
